...
namespace TeacherUser
{
    ...
    public class RenderHelper
    {
        ...
        public static void SetFormRoundRectRgn(Control control, int rgnRadius)
        {
            int hRgn = 0;
        ...
        /// 绘制窗体边框
        /// </summary>
        /// <param name="destForm">需要绘制边框的</param>
        /// <param name="g">绘制边框所用的绘图对象</param>
        /// <param name="fringeImg">边框图片</param>
        /// <param name="radius">边框的圆角矩形</param>
        public static void DrawFormFringe(Control destControl, Graphics g, Image fringeImg, int radius)
        {
            DrawNineRect(
                g,
                fringeImg,
                new Rectangle(-radius, -radius, destControl.ClientSize.Width + 2 * radius, destControl.ClientSize.Height + 2 * radius),
        ...
        /// <param name="g">绘图对象</param>
        public static void DrawFromAlphaMainPart(Control control, Graphics g)
        {
            Color[] colors = 
            {
            ...
            RectangleF destRect = new RectangleF(0, 0, control.Width, control.Height);
